...
const Position = () => {
  ...
  <div class="third-section">
    <h2>Участники</h2>
    <p>К участию в премии допускаются профессиональные работники в области бьюти индустрии, с опытом работы не менее 3-х лет, а также компании и организации, работающие в индустрии красоты по всему миру.</p>
  </div>
  <div class="third-section">
