...
const MainContent = () => {
  ...
  backgroundImage: `linear-gradient(rgba(24, 24, 24, 0.5), rgba(24, 24, 24, 0.5)), url(${BackgroundImg})`
      ...
      <div className="nomination-details">
        ...
        <h2>Визажист Года</h2>
        <p>Награда для профессионалов, создающий оригинальные и современные макияжи, владеющий разнообразными техниками для разных типов кожи и активно обучающий новое поколение визажистов.</p>
